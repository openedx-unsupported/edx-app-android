...
import org.humana.mobile.http.model.EnrollmentRequestBody;
...
import static org.humana.mobile.http.ApiConstants.COURSE_ID;
import static org.humana.mobile.http.ApiConstants.URL_COURSE_ENROLLMENTS;
import static org.humana.mobile.http.ApiConstants.URL_COURSE_OUTLINE;
import static org.humana.mobile.http.ApiConstants.URL_ENROLLMENT;
import static org.humana.mobile.http.ApiConstants.URL_LAST_ACCESS_FOR_COURSE;
import static org.humana.mobile.http.ApiConstants.URL_VIDEO_OUTLINE;
import static org.humana.mobile.http.ApiConstants.USER_NAME;
...
public interface OauthRestApi {
    ...
    Call<List<EnrolledCoursesResponse>> getEnrolledCourses(@Path(USER_NAME) String username, @Path("v") String random);

    @Headers("Cache-Control: no-cache")
    @GET(URL_COURSE_ENROLLMENTS)
    Call<List<EnrolledCoursesResponse>> getEnrolledCoursesNoCache(@Path(USER_NAME) String username, @Path("v") String random);
