...
public class CourseAPI {
    ...
    /**
     * @return Course Revenue Status for the given user.
     */
    @NonNull
    public Call<CourseRevenueResponse> getCourseRevenueStatus(@NonNull final String courseId) {
        return courseService.getCourseRevenueStatus(courseId);
    }
