...
@StringDef({COURSE_DASHBOARD, COURSE_VIDEOS, COURSE_DISCUSSION, COURSE_DATES, COURSE_HANDOUT, COURSE_ANNOUNCEMENT,
        PROGRAM, ACCOUNT, PROFILE, COURSE_DISCOVERY, PROGRAM_DISCOVERY})
