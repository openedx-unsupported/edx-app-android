...
@StringDef({MY_COURSES, COURSE_DASHBOARD, COURSE_VIDEOS, COURSE_DISCUSSION, COURSE_DATES, COURSE_HANDOUT,
        COURSE_ANNOUNCEMENT, PROGRAM, PROFILE, USER_PROFILE, DISCOVERY, DISCOVERY_COURSE_DETAIL,
        DISCOVERY_PROGRAM_DETAIL, DISCUSSION_POST, DISCUSSION_TOPIC, COURSE_COMPONENT, DELETE_ACCOUNT,
