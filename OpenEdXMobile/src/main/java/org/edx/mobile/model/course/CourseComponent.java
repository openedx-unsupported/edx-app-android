...
public class CourseComponent implements IBlock, IPathNode {
    ...
    private String courseProductSku;
    ...
    public CourseComponent(@NonNull CourseComponent other) {
        ...
        this.courseProductSku = other.courseProductSku;
    }
    ...
    public String getCourseProductSku() {
        return courseProductSku;
    }

    public void setCourseProductSku(String courseProductSku) {
        this.courseProductSku = courseProductSku;
    }
}
