...
public enum Action {
    ...
    DBCommentlike,
    BookmarkCourse,
    UnbookmarkCourse, ReplyComment, ViewSection, DownloadPostComplete, DeletePost, DeleteSection, GenerateCertificate, ViewCert, FollowUser, Search, ViewProfile, ViewPoints, ViewBadges,
