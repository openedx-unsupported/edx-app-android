...
public class UserProfilePresenter extends ViewHoldingPresenter<UserProfilePresenter.ViewInterface> {
    ...
    public UserProfilePresenter(@NonNull EventsTracker eventsTracker, @NonNull UserProfileInteractor userProfileInteractor, @NonNull UserProfileTabsInteractor userProfileTabsInteractor) {
        this.userProfileInteractor = userProfileInteractor;
        this.userProfileTabsInteractor = userProfileTabsInteractor;
        eventsTracker.trackProfileViewed(userProfileInteractor.getUsername());
    }
