...
public class FirebaseAnalytics implements Analytics {
    ...
    /**
     * This function is used to send events to Firebase. Additionally, since all
     * events use this method, any debugging/logging can be done here.
     *
     * @param eventName     Name of the event
     * @param eventBundle   Bundle of the event
     */
    ...
    public void trackScreenView(@NonNull String screenName, @Nullable String courseId,
        ...
        logEvent(event.getName(), event.getBundle());
    }
