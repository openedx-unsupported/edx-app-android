...
public class PushNotificationHelper {
    ...
    public static void onClickNotification(Context context, EventsTracker eventsTracker, Router router, BaseNotificationPayload payload) {
        if (null != payload && null != payload.getAction()) {
            switch (payload.getAction()) {
                case PushNotificationHelper.COURSE_ANNOUNCEMENT_ACTION: {
                    ...
                    eventsTracker.trackNotificationTapped(courseId);
        ...
        eventsTracker.trackNotificationTapped(null);
