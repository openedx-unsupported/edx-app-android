...
public class PushNotificationHelper {
    ...
    public static void onClickNotification(Context context, AnalyticsProvider analyticsProvider, Router router, BaseNotificationPayload payload) {
        if (null != payload && null != payload.getAction()) {
            switch (payload.getAction()) {
                case PushNotificationHelper.COURSE_ANNOUNCEMENT_ACTION: {
                    ...
                    analyticsProvider.trackNotificationTapped(courseId);
        ...
        analyticsProvider.trackNotificationTapped(null);
