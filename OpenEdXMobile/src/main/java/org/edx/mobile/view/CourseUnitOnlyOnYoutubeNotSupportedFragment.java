...
public class CourseUnitOnlyOnYoutubeNotSupportedFragment extends CourseUnitFragment {

    public static CourseUnitOnlyOnYoutubeNotSupportedFragment newInstance(CourseComponent unit) {
        CourseUnitOnlyOnYoutubeNotSupportedFragment fragment = new CourseUnitOnlyOnYoutubeNotSupportedFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_course_unit_only_on_youtube_not_supported, container, false);
