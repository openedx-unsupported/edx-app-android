...
object ProductManager {
    private val skuManager = mapOf(
        ...
        "course-v1:edX+Test101+course" to "org.edx.mobile.test_product",
        "course-v1:DemoX+PERF101+course" to "org.edx.mobile.test_product1",
        "course-v1:test2+2+2" to "org.edx.mobile.test_product2",
        "course-v1:test3+3+3" to "org.edx.mobile.test_product3"
    )
