...
//        updateFullScreen();
    ...
    protected View makeControllerView() {
        ...
        mRoot = inflate.inflate(R.layout.layout_audio_player_fragment, null);
...
//            }
    ...
    private void setAccessibilityFocusPausePlay(boolean force) {
        if ((playPauseIcon != null) && (mPauseAccessibilityRequestQueued || force)) {
            playPauseIcon.sendAccessibilityEvent(AccessibilityEvent.TYPE_VIEW_FOCUSED);
