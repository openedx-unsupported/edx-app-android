...
public enum ShareUtils {
    ...
    public static void showShareMenu(@NonNull Intent shareIntent, @NonNull View anchor, final @NonNull ShareMenuItemListener listener) {
        final Context context = anchor.getContext();
        final PopupMenu popupMenu = new PopupMenu(context, anchor);
        final SubMenu subMenu = popupMenu.getMenu().addSubMenu(R.string.share_certificate_popup_header);
