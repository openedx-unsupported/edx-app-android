...
public class Router {
    ...
    public void showCourseDetail(@NonNull Activity sourceActivity, @NonNull CourseDetail courseDetail) {
        Intent courseDetailIntent = new Intent(sourceActivity, CourseDetailActivity.class);
        courseDetailIntent.putExtra(EXTRA_COURSE_DETAIL, courseDetail);
        sourceActivity.startActivity(courseDetailIntent);
    }
}
