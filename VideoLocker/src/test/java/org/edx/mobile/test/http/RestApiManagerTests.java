...
public class RestApiManagerTests extends OkHttpBaseTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        apiManager = RestApiManager.getInstance(context);
    }
    ...
    public void testSyncLastSubsection() throws Exception {
        ...
        Map<String, SectionEntry> map = ServiceManager.getInstance().getCourseHierarchy(e.getCourse().getId());
    ...
    public void testCourseStructure() throws Exception {
        ...
        Map<String, SectionEntry> chapters = ServiceManager.getInstance().getCourseHierarchy(courseId);
    ...
    public void login() throws Exception {
        ...
        AuthResponse res = apiManager.auth(config.getName(), config.getPassword());
        assertNotNull(res);
