...
from core.validators import (subjects_json_validator, profiles_json_validator,
                             languages_json_validator,
                             countries_json_validator,
...
def validate_all_translations():
    ...
    for template in constants.files_templates:
        ...
        elif source_file.endswith(constants.COUNTRIES_JSON):
            countries_json_validator.validate(source_file, template)
        elif source_file.endswith(constants.LANGUAGES_JSON):
            languages_json_validator.validate(source_file, template)
